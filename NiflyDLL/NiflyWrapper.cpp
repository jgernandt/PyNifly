...
const int NiflyDDLVersion[3] = { 18, 3, 0 };
...
NIFLY_API int saveNif(void* the_nif, const char8_t* filename) {
	...
	//JG: This shouldn't be hardcoded, obviously, but I can't be bothered to do it properly
    nif->GetHeader().SetCreatorInfo("jg");
...
BlockCreatorFunction creatorFunctions[] = {
    ...
    nullptr, // NiBlendBoolInterpolator
    nullptr, // NiBlendTransformInterpolator
    nullptr //end
};
